...
public class UMichNetworkOpt extends Algorithm {
  private static final int NODE_PER_CLUSTER_WRITE_REDUNDANCY = 3;
  private static final int DEFAULT_CLUSTER_WRITE_REDUNDANCY = 3;

  private static UMichNetworkOpt instance;

  private int clusterWriteRedundancy;

  public static UMichNetworkOpt get() {
    if (instance == null) {
      instance = new UMichNetworkOpt();
    }
    return instance;
  }

  private UMichNetworkOpt() {
    super();
