...
public class BatalFiatRabani extends Algorithm {
  private static final int NODE_PER_CLUSTER_WRITE_REDUNDANCY = 3;
  private static final int DEFAULT_CLUSTER_WRITE_REDUNDANCY = 3;

  private static BatalFiatRabani instance;

  private int clusterWriteRedundancy;

  public static BatalFiatRabani get() {
    if (instance == null) {
      instance = new BatalFiatRabani();
    }
    return instance;
  }

  private BatalFiatRabani() {
    super();
